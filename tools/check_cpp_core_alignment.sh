...
pairs=(
  "src/akm_lincom_projection.hpp:stata/src/akm_lincom_projection.hpp"
  "src/akm_lincom_projection.hpp:r/xhdfe/src/akm_lincom_projection.hpp"
  "src/akm_lincom_projection.hpp:share/xhdfe_estimation_cpp/src/akm_lincom_projection.hpp"
  "src/akm_lincom_projection.hpp:share/xhdfe_estimation_cpp/stata/src/akm_lincom_projection.hpp"
  ...
  "src/wide_float.hpp:stata/src/wide_float.hpp"
  "src/cache_digest.hpp:stata/src/cache_digest.hpp"
  "src/cache_digest.hpp:r/xhdfe/src/cache_digest.hpp"
  "src/cache_digest.hpp:share/xhdfe_estimation_cpp/src/cache_digest.hpp"
  "src/cache_digest.hpp:share/xhdfe_estimation_cpp/stata/src/cache_digest.hpp"
  "src/fe_recovery_scale.hpp:stata/src/fe_recovery_scale.hpp"
  "src/fe_recovery_scale.hpp:r/xhdfe/src/fe_recovery_scale.hpp"
  "src/fe_recovery_scale.hpp:share/xhdfe_estimation_cpp/src/fe_recovery_scale.hpp"
  "src/fe_recovery_scale.hpp:share/xhdfe_estimation_cpp/stata/src/fe_recovery_scale.hpp"
  "include/fe_absorption.hpp:stata/include/fe_absorption.hpp"
  "src/fe_absorption_cuda.hpp:stata/include/fe_absorption_cuda.hpp"
  "src/fe_absorption_cuda.hpp:include/fe_absorption_cuda.hpp"
  "include/fe_absorption_cuda.hpp:share/xhdfe_estimation_cpp/include/fe_absorption_cuda.hpp"
  ...
  "include/hdfe/student_t_detail.hpp:stata/include/hdfe/student_t_detail.hpp"
  "include/hdfe/ieee_bits.hpp:stata/include/hdfe/ieee_bits.hpp"
  ...
  "src/wide_float.hpp:share/xhdfe_estimation_cpp/src/wide_float.hpp"
  ...
  "include/hdfe/student_t_detail.hpp:share/xhdfe_estimation_cpp/include/hdfe/student_t_detail.hpp"
  "include/hdfe/ieee_bits.hpp:share/xhdfe_estimation_cpp/include/hdfe/ieee_bits.hpp"
  ...
  "stata/src/wide_float.hpp:share/xhdfe_estimation_cpp/stata/src/wide_float.hpp"
  ...
  "include/hdfe/student_t_detail.hpp:share/xhdfe_estimation_cpp/stata/include/hdfe/student_t_detail.hpp"
  "stata/include/hdfe/ieee_bits.hpp:share/xhdfe_estimation_cpp/stata/include/hdfe/ieee_bits.hpp"
  ...
  "stata/src/xfe_plugin.cpp:share/xhdfe_estimation_cpp/stata/src/xfe_plugin.cpp"
  ...
  "src/wide_float.hpp:r/xhdfe/src/wide_float.hpp"
  ...
  "include/hdfe/student_t_detail.hpp:r/xhdfe/src/include/hdfe/student_t_detail.hpp"
  "include/hdfe/ieee_bits.hpp:r/xhdfe/src/include/hdfe/ieee_bits.hpp"
  ...
  # The share/ tree ships a Stata ado/sthlp alongside the C++ it mirrors, and
  # nothing checked them: they sat at 2.21.0 25jul2026 while the C++ beside
  # them was refreshed twice, so an offline build from share/ would have
  # driven a current plugin with a two-release-old ado (04aug2026 audit F-2).
  "stata/xhdfe.ado:share/xhdfe_estimation_cpp/stata/xhdfe.ado"
  "stata/xhdfe.sthlp:share/xhdfe_estimation_cpp/stata/xhdfe.sthlp"
)
