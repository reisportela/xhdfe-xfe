...
| Gate | Resultado |
|---|---|
| `tests/validation/VALIDATE_GELBACH.py` | PASS, incluindo identidades e oracles |
| `tests/validation/VALIDATE_GELBACH_ADVERSARIAL.py` | PASS, incluindo guards de threads, rank, pesos e regularidade |
| `tests/validation/VALIDATE_GELBACH_PYFIXEST_FEATURES.py` | PASS |
| `tests/validation/VALIDATE_GELBACH_SAMPLE_PROVENANCE.py` | PASS, 36 checks |
| `tests/validation/VALIDATE_GELBACH_REMEDIATION_COVERAGE.py` | PASS |
| `tests/validation/VALIDATE_GELBACH_FRONTENDS.py`, CPU | PASS |
| `tests/validation/VALIDATE_GELBACH_FRONTENDS.py`, CUDA | PASS, Python/R/Stata reportaram `cuda` e `used` |
| `tests/validation/VALIDATE_GELBACH_HELP.py` | PASS, 111 checks |
