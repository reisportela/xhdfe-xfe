...
| gate | resultado |
|---|---|
| `tests/validation/VALIDATE_AKM_KSS.py --module-dir build` | **ALL CHECKS PASSED**; GPU corretamente skipped no build CPU |
| `tests/validation/VALIDATE_AKM_KSS.py --module-dir build_cuda` | **ALL CHECKS PASSED**; CPU/GPU max `1.11e-16`; determinismo GPU |
