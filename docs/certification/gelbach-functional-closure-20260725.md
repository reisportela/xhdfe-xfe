...
| `tests/validation/VALIDATE_GELBACH.py` | todos os checks passaram |
| `tests/validation/VALIDATE_GELBACH_ADVERSARIAL.py` | todos os checks adversariais passaram |
| `tests/validation/VALIDATE_GELBACH_PYFIXEST_FEATURES.py` | todas as funcionalidades passaram |
| `tests/validation/VALIDATE_GELBACH_SAMPLE_PROVENANCE.py` | 36 checks passaram |
| `tests/validation/VALIDATE_GELBACH_HELP.py` | 111 checks passaram |
