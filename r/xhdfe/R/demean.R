...
#'   \code{abs_residual_rel}, \code{krylov_internal_tolerance},
#'   \code{krylov_max_final_backward_error}, \code{krylov_max_condition},
#'   \code{krylov_max_condition_times_backward_error}, \code{precision_certified},
