...
# stata/xhdfe.sthlp (version 2.26.2). The NAMESPACE is maintained by hand;
...
#' same estimator core (version 2.26.2) behind the Stata \code{xhdfe} command
...
#'
#' \strong{Version 2.26.2 certification boundary.} A successful GPU-use
...
#' boundary with a CPU fallback; see the 2.26.2 release notes for the exact
#' failed surfaces.
#'
#' \tabular{lll}{
