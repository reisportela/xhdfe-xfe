...
{phang}
{bf:Version 2.26.0 certification boundary.} {cmd:e(gpu_used)} proves execution on the GPU; it is not by itself a
...
the exact failed surfaces and measurements are listed in the 2.26.0 release notes.
...
regression via a C++ backend." Version 2.26.0.
